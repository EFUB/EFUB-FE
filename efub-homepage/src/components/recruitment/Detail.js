...
const Detail = () => {
    return (
        <Wrapper>
            ...
            <Text margin="2rem">이화 웹 개발 커리어 클럽 EFUB에서 웹 개발자 및 웹 디자이너 여러분을 모집합니다.</Text>
            <Text margin="2rem">Ewha FrontEnd UXUI BackEnd (이하 EFUB)의 약자로, 세 파트가 협업하여 하나의 프로젝트를 완성하는 것을 목표로 하고 있습니다. EFUB은 2021년 1기를 시작으로 이화여대 인재개발원 산하 '커리어클럽'에 웹개발 파트에 소속되어 있으며, 교내 최대 규모의 웹개발 동아리입니다.</Text>
            <Text margin="8rem">리드 개발자는 곧장 프로젝트 착수와 세미나 주최가 가능한 인원이며, 인턴 개발자는 양쪽 분야의 리드를 보고 학습을 진행해 자신이 어느 쪽의 직무가 적성에 맞는지 탐색할 수 있습니다.
                디자이너의 경우, 리드 포지션만을 선발하여 곧장 프로젝트에 착수 가능한 인원을 선발합니다.</Text>
            <Line>
                <Textbox margin="8rem">
